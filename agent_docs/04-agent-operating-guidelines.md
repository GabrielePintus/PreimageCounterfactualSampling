...
- Training bugs or hyperparameter workflows:
  - start with `agent_docs/01-training-playbook.md`
- Counterfactual algorithm or certification behavior:
  - start with `agent_docs/02-certified-atlas-playbook.md`
- Dependency boundary or package ownership questions:
  - start with `agent_docs/03-subprojects-and-dependencies.md`
...
- update the closest `agent_docs/*.md` file with new entrypoints or commands
