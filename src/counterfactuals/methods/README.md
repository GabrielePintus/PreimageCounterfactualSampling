...
| File | Method | Paper |
|---|---|---|
| `wachter.py` | Wachter | Wachter, Mittelstadt, Russell (2017). "Counterfactual Explanations without Opening the Black Box". Harvard JOLT. |
| `dice.py` | DiCE | Mothilal, Sharma, Tan (2020). "Explaining Machine Learning Classifiers through Diverse Counterfactual Explanations". FAccT. |
...
| `my_method.py` | CPP (CertifiedAtlas) | This work. |
